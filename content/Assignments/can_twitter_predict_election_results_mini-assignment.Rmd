...
Date: 2018-05-25 23:59
Tags: mini-assignment
Slug: can-twitter-predict-election-results-mini-assignment
Summary: A mini-assignment about a data science study that used Twitter data to predict election outcomes.
Show_summary: true
Show_link: true
...
[**Due:** May 25, 2018 @ 11:59pm]{.h3}

::: {.no-bullets}
*   [`r icon_github` &nbsp; [**Twitter mini-assignment** repo]{.card-downloads-format}][github-classroom]
:::
...
This mini-assignment is licensed under a [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](http://creativecommons.org/licenses/by-nc-sa/4.0/).
...
[github-classroom]:      https://classroom.github.com/a/ZMdqdsxL
